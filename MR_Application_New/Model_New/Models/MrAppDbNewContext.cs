...
public partial class MrAppDbNewContext : DbContext
{
    ...
    public DbSet<TblChannelMaster> tblChannelMasters { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=BCBLR-VP3580;Database=MR_APP_DB_New_Test;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    public async Task LogErrorAsync(string controller, string action, string errorMessage, string stackTrace)
    {
        try
        {
            var errorLog = new tbl_Error_Log
            {
            ...
            await Tbl_Error_Logs.AddAsync(errorLog);
