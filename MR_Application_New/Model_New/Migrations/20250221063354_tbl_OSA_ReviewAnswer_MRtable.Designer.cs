...
namespace Model_New.Migrations
{
    ...
    [Migration("20250221063354_tbl_OSA_ReviewAnswer_MRtable")]
    partial class tbl_OSA_ReviewAnswer_MRtable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model_New.Models.ReviewAnswer", b =>
                {
                    ...
                    b.Property<int?>("Tbl_QuestionsQuestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Tbl_QuestionsQuestionId");
            ...
            modelBuilder.Entity("Model_New.Models.Tbl_OSA_ReviewAnswer_MR", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("tbl_OSA_ReviewAnswer_MR");
                });

            modelBuilder.Entity("Model_New.Models.Tbl_Questions", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model_New.Models.Tbl_SRMaster_data", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Party_HUL_Code")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("RS_Code")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("SMN_Name")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("Servicing_PLG")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.ToTable("tbl_SRMaster_Datas");
                });

            modelBuilder.Entity("Model_New.Models.Tbl_capturedata_log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model_New.Models.tbl_Error_Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Tbl_Error_Logs");
                });

            modelBuilder.Entity("Model_New.Models.tbl_OSA_question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OutletSubType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Model_New.Models.ReviewAnswer", b =>
                {
                    ...
                    b.HasOne("Model_New.Models.Tbl_Questions", null)
                        .WithMany("ReviewAnswers")
                        .HasForeignKey("Tbl_QuestionsQuestionId");
