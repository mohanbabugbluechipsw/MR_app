...
namespace MR_Application_New.Controllers
{
    public class QuestionsController : Controller
    {
...

        {
            ...
            var channelCodes = _context.tblChannelMasters
                  .GroupBy(d => new { d.Channel, d.Element, d.Sub_element })
                  .Select(g => g.Key)
                  .ToList();
            ...
            ViewBag.ChannelCodes = channelCodes; // Passing the full list
        ...
        public IActionResult GetPartyData(int distributorId)
        {
            ...
            var partyData = _context.OutLetMasterDetails
                                     ...
                                     p.PartyMasterCode,
                                     p.PartyName,
                                        p.SecondarychannelCode,
                                        p.PrimarychannelCode
                                     })
        ...
        [HttpPost]
        public async Task<IActionResult> Create(string Question, string Distributor, string OutletType, string Type, bool Status, bool Ba)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Tbl_Questions question)
        {
